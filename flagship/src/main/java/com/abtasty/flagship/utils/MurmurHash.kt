...
class MurmurHash {
    ...
    companion object {
        ...
        fun getAllocationFromMurmur(variationGroupId: String?, visitorId: String?): Int {
            return if (variationGroupId != null && visitorId != null) {
                val hash: Long = murmurHash3_x86_32(variationGroupId + visitorId)
                (hash % 100).toInt()
            } else {
                Random.nextInt(100)
            }
        ...
        fun murmurHash3_x86_32(source : String) : Long {
