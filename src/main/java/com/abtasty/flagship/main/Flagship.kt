...
class Flagship {
     ...
     */
    class Builder(private var appContext: Context, private var envId: String, private var apiKey : String) {

        private var ready: (() -> Unit)? = null
        private var visitorContext = HashMap<String, Any>()
        ...
        fun start() {
            when (true) {
                envId.isEmpty() || envId.isBlank() -> Logger.e(Logger.TAG.INFO, "Start : envId must not be empty.")
                apiKey.isEmpty() || apiKey.isBlank() -> Logger.e(Logger.TAG.INFO, "Start : apiKey must not be empty.")
                else -> start(appContext, envId, apiKey, ready, visitorContext)
            }
        }
    }
    ...
    companion object {
        ...
        internal fun start(
                ...
                apiKey: String,
                ready: (() -> Unit)? = null,
                visitorContext: HashMap<String, Any>
        ) {
            this.apiKey = apiKey
            this.clientId = envId
            this.visitorId =
